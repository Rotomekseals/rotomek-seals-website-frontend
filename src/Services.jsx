  ...
  const services = [
    {
      ...
      description:
        'Custom sealing solutions designed by our expert engineering team for specific applications.',
      features: [
    ...
    },
    {
      ...
      description:
        'Professional repair services for mechanical seals, sleeves, and pump shafts.',
      features: [
    ...
    },
    {
      ...
      description:
        'Comprehensive technical assistance from our experienced support team.',
      features: [
    ...
    },
    {
      ...
      description:
        'Professional on-site installation and commissioning services.',
      features: [
  ...
  const supportFeatures = [
    {
      ...
      description:
        'Quick turnaround times for urgent requirements and emergency situations.'
    },
    {
      icon: Shield,
      title: 'Quality Assurance',
      description:
        'Rigorous quality control processes ensuring consistent performance.'
    },
    {
      icon: HeadphonesIcon,
      title: '24/7 Support',
  ...
  const processSteps = [
    {
      ...
      title: 'Consultation',
      description:
        'Initial discussion to understand your specific requirements and challenges.'
    },
    {
      step: '02',
      title: 'Analysis',
      description:
        'Detailed application analysis and solution recommendation.'
    },
    {
      step: '03',
      title: 'Design',
    ...
    },
    {
      ...
      title: 'Delivery',
      description:
        'Timely delivery with installation and support services.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-6 py-3 bg-white text-orange-600 hover:bg-gray-100 rounded font-medium">
              Contact Our Experts
            </button>
            <button className="px-6 py-3 border border-white text-white hover:bg-white hover:text-orange-600 rounded font-medium">
